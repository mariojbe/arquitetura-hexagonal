...
public class ProdutoServiceImp implements ProdutoServicePort {
    ...
    @Autowired
    public ProdutoServiceImp(@Qualifier("produtoRepository") ProdutoRepositoryPort produtoRepository) {
    ...
    @Override
    public void atualizarEstoque(Long id, EstoqueDTO estoqueDTO) throws ChangeSetPersister.NotFoundException {
        Produto produto = this.produtoRepository.buscarPeloId(id);
